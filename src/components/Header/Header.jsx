...
const Header = () => {
  ...
  return (
    <header className='bg-white/10 backdrop-blur-sm py-0 relative'>
      <LayoutSize>
        <div className={`navbar py-0 flex justify-between items-center ${theme && "text-tertiary"}`}>
          <div className='navbar-star'>
            <div className="dropdown">
              ...
              <ul tabIndex={0} className="menu fixed top-0 menu-sm dropdown-content mt-3 pl-4 py-5 shadow bg-base-100 rounded-box w-52 bg-tertiary/10 backdrop-blur-sm gap-5">
            ...
            <div className='hidden md:block text-2xl font-bold'>
              <Link><img src={theme ? '/images/footerlogo.svg' : '/images/logo.svg'} className='w-44' /></Link>
            </div>
          </div>
          <div className='md:hidden'>
            <Link><img src={theme ? '/images/footerlogo.svg' : '/images/logo.svg'} className='w-36 sm:w-52' /></Link>
          </div>
